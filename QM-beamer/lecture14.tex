...
\begin{frame} 
    \frametitle{}
    \begin{tcolorbox}[colback=yellow!5,colframe=red!75!black,title=幺正矩阵和厄密矩阵]
        \begin{enumerate}
...
\begin{frame} 
    \frametitle{}
    \begin{tcolorbox}[colback=yellow!5,colframe=red!75!black,title=幺正变换]
...
\begin{frame} 
    \frametitle{}
    \begin{tcolorbox}[colback=yellow!5,colframe=yellow!75!black,title=旋转矩阵]
...
\begin{frame} 
    \frametitle{}
    \begin{tcolorbox}[colback=yellow!5,colframe=yellow!75!black,title=1、基矢变换]
...
\section{波函数变换}
\begin{frame} 
    \begin{tcolorbox}[colback=yellow!5,colframe=yellow!75!black,title=2、波函数变换]
...
\section{算符变换}
\begin{frame} 
    \begin{tcolorbox}[colback=yellow!5,colframe=yellow!75!black,title=3、算符变换]
...
\begin{frame} 
    \begin{tcolorbox}[colback=yellow!5,colframe=yellow!75!black,title=幺正变换性质1]
        试证明：幺正变换不改变算符的本征值 
    \end{tcolorbox}
    \alert{证明：}
...
\begin{frame} 
    \begin{tcolorbox}[colback=yellow!5,colframe=yellow!75!black,title=幺正变换性质2]
        试证明：幺正变换不改变矩阵的迹
    \end{tcolorbox}
...
\begin{frame} 
    \begin{tcolorbox}[colback=yellow!5,colframe=yellow!75!black,title=幺正变换性质3]
...
\end{frame}  
\begin{frame}
    \begin{tcolorbox}[colback=yellow!5,colframe=red!75!black,title=3）推广]
       \begin{enumerate}
...
\begin{frame}
    \begin{tcolorbox}[colback=yellow!5,colframe=red!75!black,title=4）构造S矩阵的方法]
